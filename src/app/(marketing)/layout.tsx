 ...
 * préférence, on lui sert l'UI accueillante claire). Pas de toggle thème ici.
 *
 * Traduction : même machinerie que le dashboard (PanelLangProvider +
 * AutoTranslateWrapper + sélecteur de langue dans le header). L'action de
 * traduction (translatePanelBatch) n'a pas d'auth → marche pour un visiteur
 * anonyme. La langue est mémorisée dans le cookie partagé `ruliz_panel_lang`.
 */
export default async function MarketingLayout({
  ...
  const lang: SupportedLang = isSupportedLang(langCookie) ? langCookie : "fr";

  return (
    <PanelLangProvider initialLang={lang}>
